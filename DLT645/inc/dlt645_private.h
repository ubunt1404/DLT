#ifndef __DLT645_PRIVATE_H
#define __DLT645_PRIVATE_H
...
//645 调用底层接口接收数据
extern int dlt645_receive_msg(SerialPort self, dlt645_t *ctx, uint8_t *msg, uint16_t len, uint32_t code, dlt645_protocal protocal);
//645 调用底层接口发送
extern int dlt645_send_msg(SerialPort self, dlt645_t *ctx, uint8_t *msg, int len);
